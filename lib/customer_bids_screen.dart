  ...
  void _showCounterBidDialog(int bidId, String currentAmount) {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(28), side: BorderSide(color: Colors.white.withOpacity(0.05), width: 1)),
        title: Column(
          children: [
            Container(
            ...
            Text("Karşı Teklif Ver", textAlign: TextAlign.center, style: TextStyle(fontWeight: FontWeight.bold, color: isDark ? Colors.white : const Color(0xFF0F172A), fontSize: 22)),
          ],
        ),
        content: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            Text("Ustanın Teklifi: $currentAmount", style: const TextStyle(fontWeight: FontWeight.bold, color: Color(0xFFF59E0B), fontSize: 16)),
            ...
            TextField(
              ...
              decoration: InputDecoration(
                ...
                labelStyle: TextStyle(fontSize: 14, fontWeight: FontWeight.w500, color: isDark ? Colors.white60 : Colors.black54),
                filled: true,
            ...
            Row(
              ...
              children: [
                ...
                Text("Maksimum 2 pazarlık hakkınız var.", style: TextStyle(fontSize: 12, color: isDark ? Colors.white70 : Colors.black87, fontWeight: FontWeight.normal)),
              ],
            ),
          ],
        ),
  ...
  Future<void> _cancelJob() async {
    ...
    bool confirm = await showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        title: const Text("Talebi İptal Et", style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white)),
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Container(
                          ...
                          decoration: BoxDecoration(
                            color: cardColor,
                            borderRadius: BorderRadius.circular(24),
                            border: Border.all(color: isDark ? Colors.white.withOpacity(0.05) : const Color(0xFFE2E8F0), width: 1),
                            boxShadow: [BoxShadow(color: isDark ? Colors.black.withOpacity(0.15) : const Color(0xFF94A3B8).withOpacity(0.15), blurRadius: 20, offset: const Offset(0, 8))],
                          ),
                          child: Column(
                            children: [
                              Row(
                                children: [
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        Text(providerName, style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: textColor, letterSpacing: -0.3)),
                                        ...
                                        Container(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              ...
                                              const SizedBox(width: 6),
                                              Text(rating, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 13, color: Color(0xFFD97706))),
                                            ],
                                          ),
                                        ),
                                      ],
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Text(displayPrice, style: TextStyle(fontSize: priceVal > 0 ? 28 : 18, fontWeight: FontWeight.bold, color: const Color(0xFF10B981), letterSpacing: -0.5)),
                                    ],
                                  ),
                                ],
                              ),
                                ...
                                Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Expanded(child: Text(note, style: TextStyle(color: textColor, fontSize: 14, fontWeight: FontWeight.normal, fontStyle: FontStyle.italic))),
                                    ],
                                  ),
                                ),
                              ],
                                ...
                                Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      const Expanded(child: Text("Yanıtınız iletildi, ustanın dönüşü bekleniyor.", style: TextStyle(color: Color(0xFFD97706), fontWeight: FontWeight.bold, fontSize: 14))),
                                    ],
                                  ),
                                )
                              else
                                    ...
                                    Expanded(
                                      child: OutlinedButton.icon(
                                        ...
                                        style: OutlinedButton.styleFrom(
                                          ...
                                          side: BorderSide(color: canNegotiate ? const Color(0xFF10B981) : (isDark ? Colors.white24 : const Color(0xFFCBD5E1)), width: 1.5),
                                          shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16)),
                                          foregroundColor: canNegotiate ? const Color(0xFF10B981) : subtitleColor,
                                        ),
                                        label: FittedBox(child: Text(canNegotiate ? "Pazarlık / Yanıt" : "Profili Gör", style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 16))),
                                      ),
                                    ),
                                    if (priceVal > 0) ...[
                                      const SizedBox(width: 12),
                                      Expanded(
                                        child: Container(
                                          ...
                                          child: ElevatedButton.icon(
                                            icon: isProcessing ? const SizedBox.shrink() : const Icon(Icons.check_circle_outline_rounded, color: Colors.white, size: 22),
                                            ...
                                            label: isProcessing
                                                ...
                                                : const FittedBox(child: Text("Kabul Et", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 16))),
                                          ),
                                        ),
                                      ),
                                    ],
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                gradient: RadialGradient(
                  colors: [const Color(0xFF10B981).withOpacity(0.2), Colors.transparent],
                  radius: 0.8,
                ),
                shape: BoxShape.circle,
              ),
              child: Container(
                ...
                child: const Icon(Icons.radar_rounded, size: 64, color: Color(0xFF10B981)),
              ),
            ),
          ),
          const SizedBox(height: 36),
          Text("$currentRadius KM İçinde Aranıyor...", style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: textColor, letterSpacing: -0.5)),
          const SizedBox(height: 16),
          Text("Konumunuza en yakın ustalar bildirimi aldı.\nYanıtlar canlı olarak buraya düşecektir.", textAlign: TextAlign.center, style: TextStyle(fontSize: 16, color: subtitleColor, height: 1.6, fontWeight: FontWeight.normal)),
        ],
      ),
    );
  }
