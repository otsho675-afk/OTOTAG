...
class _ProviderBidsScreenState extends State<ProviderBidsScreen> with SingleTickerProviderStateMixin, WidgetsBindingObserver {
  ...
  // Tema Renkleri (Siyah ve Neon Yeşil)
        ...
        content: Row(
          children: [
            Container(
              ...
              child: Icon(isError ? Icons.error_outline_rounded : Icons.check_circle_outline_rounded, color: isError ? alertRed : neonGreen, size: 22),
            ),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("İş ve Kazanç Raporu", style: TextStyle(fontWeight: FontWeight.w900, fontSize: 20, color: Colors.white, letterSpacing: -0.5)),
                        ...
                        child: Column(
                          ...
                          children: [
                            Container(
                              ...
                              child: const Icon(Icons.inbox_rounded, size: 56, color: neonGreen),
                            ),
                            const SizedBox(height: 28),
                            const Text("Kayıt Bulunamadı", style: TextStyle(color: Colors.white, fontSize: 22, fontWeight: FontWeight.w900, letterSpacing: -0.5), textAlign: TextAlign.center),
                            const SizedBox(height: 10),
                            const Text("Şu an aktif veya geçmiş\nbir işleminiz bulunmuyor.", textAlign: TextAlign.center, style: TextStyle(color: textGray, fontSize: 15, height: 1.5, fontWeight: FontWeight.w500)),
                          ],
                        ),
                      ),
                    ),
                            ...
                            Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Row(
                                    children: [
                                      Icon(Icons.analytics_rounded, size: 18, color: textGray.withOpacity(0.8)),
                                      const SizedBox(width: 8),
                                      const Text("Filtrelenen İşlem:", style: TextStyle(color: textGray, fontWeight: FontWeight.w700, fontSize: 13)),
                                    ],
                                  ),
                                  Text("${filteredBids.length} Adet", style: const TextStyle(color: neonGreen, fontWeight: FontWeight.w900, fontSize: 15)),
                                ],
                              ),
                            ),
                            Expanded(
                                          ...
                                          child: Row(
                                            children: [
                                              Container(
                                                ...
                                                child: Icon(statusIcon, color: isCompleted ? pureBlack : statusColor, size: 26),
                                              ),
                                              ...
                                              Expanded(
                                                child: Column(
                                                  ...
                                                  children: [
                                                    Text("İşlem #${job['job_id']}", style: const TextStyle(fontSize: 17, fontWeight: FontWeight.w900, color: Colors.white, letterSpacing: -0.3), overflow: TextOverflow.ellipsis),
                                                      ...
                                                      children: [
                                                        ...
                                                        Expanded(
                                                          child: Text(
                                                            ...
                                                            style: const TextStyle(fontSize: 13, color: textGray, fontWeight: FontWeight.w700, letterSpacing: 0.3),
                                              ...
                                              Column(
                                                ...
                                                children: [
                                                  Text("Kazanç", style: TextStyle(fontSize: 13, color: statusColor.withOpacity(0.8), fontWeight: FontWeight.w700)),
                                                  ...
                                                  SizedBox(
                                                    ...
                                                    child: FittedBox(
                                                       ...
                                                       child: Text("${job['agreed_price'] ?? '0'} ₺", style: TextStyle(fontSize: 24, fontWeight: FontWeight.w900, color: statusColor, letterSpacing: -0.5)),
                                                    ),
                                                  ),
                                                ],
                                              ),
